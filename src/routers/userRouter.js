...
const { getAllUsers, getUser, deleteUser,updateRole, registerUser, loginUser, loginUserRefreshToken, sendpasslink, forgotPassword, postForgotPassword} = require("../controller/userController");
